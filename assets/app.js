...
const Lenis = (function () {
    ...
    //import Lenis from './modules/lenis/lenis.js';
    // package.json
    const lenisversion = "1.3.17";
    ...
    var Lenis = class {
        ...
        constructor({
            ...
            window.lenisversion = lenisversion;
...
modules.forEach(module => {
    const slug = module.dataset.module.replace(/^\/+|\/+$/g, '').split("/");
    if (module.dataset.context === "@visible true") {
        new IntersectionObserver((entries, observer) => entries.forEach(entry => {
            if (entry.isIntersecting) {
               
                import(`./${slug[0]}/${slug[1]}/${slug[1]}.${version}`).then(e => e.default(module));
